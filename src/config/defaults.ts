    ...
    categories: [
      {
        ...
        items: [
          { id: "1", text: "truck", href: "/" },
          { id: "2", text: "car", href: "/" },
          { id: "3", text: "moon", href: "/" },
          { id: "4", text: "lights", href: "/" },
        ],
      },
      {
        id: "vqa",
        name: "Visual Q&A",
        items: [
          { id: "1", text: "what time of day is it?", href: "/" },
          {
            id: "2",
            text: "how many people are in the scene?",
            href: "/",
          },
          { id: "3", text: "what's the weather like?", href: "/" },
        ],
      },
      {
        id: "caption",
        ...
        items: [
          { id: "1", text: "describe the scene", href: "/" },
          { id: "2", text: "describe the mood", href: "/" },
          { id: "3", text: "describe the lighting", href: "/" },
        ],
      },
    ],
    animations: {
...
export const macWindowVariants: Record<
  Config["macWindow"]["variant"],
  MacWindowVariantStyle
> = {
  default: {
  ...
  gradient: {
    backgroundColor:
      "linear-gradient(135deg, rgba(45,45,45,0.9) 0%, rgba(20,20,20,0.95) 50%, rgba(0,0,0,1) 100%)",
